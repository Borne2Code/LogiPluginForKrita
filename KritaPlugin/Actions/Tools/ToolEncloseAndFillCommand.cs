...
namespace Loupedeck.KritaPlugin
{
    ...
    public class ToolEncloseAndFillCommand : PluginDynamicCommand
    {
        ...
        {
            return EmbeddedResources.ReadImage(EmbeddedResources.FindFile("ToolEncloseAndFill.png"));
        }

        protected override void RunCommand(string actionParameter)
        {
            KritaPlugin.Client.KritaInstance.ExecuteAction(ActionsNames.KisToolEncloseAndFill).Wait();
        }
    }
}
