...
namespace Logi.KritaPlugin.Constants
{
    ...
    {
        public static DynamicFolderAdjustmentDefinition SelectCurrent => new DynamicFolderAdjustmentDefinition("Select", "Logi.KritaPlugin.images.Layers.Select.png", LayerCurrentAdjustment.AdjustCurrentLayer);
        public static DynamicFolderAdjustmentWithValueDefinition Opacity => new DynamicFolderAdjustmentWithValueDefinition("Opacity",
            "Logi.KritaPlugin.images.Layers.Opacity.png",
            LayerOpacityAdjustment.AdjustOpacity,
            LayerOpacityAdjustment.GetOpcityValue,
            LayerOpacityAdjustment.ResetOpacity);
        public static DynamicFolderCommandDefinition Isolate => new DynamicFolderCommandDefinition("Isolate", "Logi.KritaPlugin.images.Layers.Isolate.png", ActionsNames.Isolate_active_layer, false);
        public static DynamicFolderAdjustmentDefinition Move => new DynamicFolderAdjustmentDefinition("Move", "Logi.KritaPlugin.images.Layers.Move.png", LayerMoveAdjustment.AdjustMoveLayer);
        public static DynamicFolderCommandDefinition Style => new DynamicFolderCommandDefinition("Style", "Logi.KritaPlugin.images.Layers.Style.png", ActionsNames.Layer_style);
        ...
        public static DynamicFolderCommandDefinition Rename => new DynamicFolderCommandDefinition("Rename", "Logi.KritaPlugin.images.Layers.Rename.png", ActionsNames.RenameCurrentLayer);
        public static DynamicFolderCommandDefinition Duplicate => new DynamicFolderCommandDefinition("Duplicate", "Logi.KritaPlugin.images.Layers.Duplicate.png", ActionsNames.Duplicatelayer);
        public static DynamicFolderCommandDefinition Delete => new DynamicFolderCommandDefinition("Delete", "Logi.KritaPlugin.images.Layers.Delete.png", ActionsNames.Remove_layer);
        public static DynamicFolderCommandDefinition LockUnlock => new DynamicFolderCommandDefinition("Lock", "Logi.KritaPlugin.images.Layers.Lock.png", ActionsNames.Toggle_layer_lock, false);
        public static DynamicFolderCommandDefinition ToggleVisible => new DynamicFolderCommandDefinition("Visible", "Logi.KritaPlugin.images.Layers.ToggleVisible.png", ActionsNames.Toggle_layer_visibility, false);
