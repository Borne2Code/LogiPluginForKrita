    ...
    public class FilterEdgeDetection : FilterDialogBase
    {
        ...
        static internal FilterDialogDefinition GetDefinition()
        {
            return new FilterDialogDefinition("Edge detection",
                ...
                [
                    new FilterAdjustmentDefinition("Horizontal radius", (dialog, _, delta) => ((KritaFilterEdgeDetecttion)dialog.Dialog).AdjustHorizontalRadius(delta).Result),
                    new FilterAdjustmentDefinition("Vertical radius", (dialog, _, delta) => ((KritaFilterEdgeDetecttion)dialog.Dialog).AdjustVerticalRadius(delta).Result),
                ]);
        }
    }
}
